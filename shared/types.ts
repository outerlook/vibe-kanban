...
export type BulkDeleteTasksRequest = { project_id: string, task_ids: Array<string>, };

export type BulkDeleteTasksResponse = { deleted_tasks: Array<DeletedTaskSummary>, };

export type BulkUpdateTaskStatusRequest = { project_id: string, task_ids: Array<string>, status: TaskStatus, };

export type BulkUpdateTaskStatusResponse = { tasks: Array<Task>, };

export type DeletedTaskSummary = { id: string, project_id: string, status: TaskStatus, };
...
export enum ScratchType { DRAFT_TASK = "DRAFT_TASK", DRAFT_FOLLOW_UP = "DRAFT_FOLLOW_UP", DRAFT_CONVERSATION_MESSAGE = "DRAFT_CONVERSATION_MESSAGE" }
...
export type ProjectPrPage = { limit: number, next_cursor: string | null, has_more: boolean, };
...
export enum SoundFile { ABSTRACT_SOUND1 = "ABSTRACT_SOUND1", ABSTRACT_SOUND2 = "ABSTRACT_SOUND2", ABSTRACT_SOUND3 = "ABSTRACT_SOUND3", ABSTRACT_SOUND4 = "ABSTRACT_SOUND4", COW_MOOING = "COW_MOOING", ERROR_BUZZER = "ERROR_BUZZER", PHONE_VIBRATION = "PHONE_VIBRATION", ROOSTER = "ROOSTER" }
...
export type GitStateChangeKind = "head" | "index" | "refs" | "rebase_head" | "merge_head" | "cherry_pick_head" | "revert_head" | "config" | "other";
...
export type SkillInfo = { name: string, description: string | null, namespace: string | null, };

export type SkillsData = { slash_commands: Array<string>, skills: Array<SkillInfo>, };
