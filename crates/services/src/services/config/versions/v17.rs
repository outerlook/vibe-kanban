...
use crate::services::{
    config::{ConfigError, versions::v16},
...
impl Config {
    fn from_v16_config(old_config: v16::Config) -> Self {
        Self {
            ...
            orchestration_event_publisher: old_config.orchestration_event_publisher,
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_v16_to_v17_migration_drops_internal_workflow_fields() {
        ...
        assert_eq!(
            v17_config.orchestration_event_publisher,
    ...
    fn test_v17_roundtrip() {
        let config = Config {
            pr_auto_description_prompt: Some("Describe the PR".to_string()),
            ..Config::default()
        };
    ...
    #[test]
    fn test_v17_deserialize_without_orchestration_event_publisher_field() {
    ...
    #[test]
    fn test_v17_publisher_config_roundtrip_and_validation() {
        let config = Config {
