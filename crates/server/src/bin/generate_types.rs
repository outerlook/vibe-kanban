...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::projects::GetProjectPrsQuery::decl(),
        services::services::pr_cache::PrWithComments::decl(),
        services::services::pr_cache::RepoPrs::decl(),
        services::services::pr_cache::ProjectPrsPage::decl(),
